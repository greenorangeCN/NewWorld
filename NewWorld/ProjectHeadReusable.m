...
@implementation ProjectHeadReusable
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"ProjectHeadReusable" owner:self options:nil];
